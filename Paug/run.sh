...
python generate_answer.py --model qwen2.5-0.5b --model_path outputs/pt-qwen/final_model \
--output_path outputs/pt-qwen  --mode train --gpu 0
python generate_answer.py --model qwen2.5-0.5b --model_path outputs/pt-qwen/final_model \
--output_path outputs/pt-qwen  --mode test --gpu 0
...
--output_path outputs/pt-pythia  --mode train --gpu 0
python generate_answer_pt.py --model pythia-160m --model_path outputs/pt-pythia/final_model \
--output_path outputs/pt-pythia  --mode test --gpu 0